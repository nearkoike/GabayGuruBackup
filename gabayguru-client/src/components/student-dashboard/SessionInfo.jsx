    ...
    <div className="rounded p-4 bg-white shadow-md grow">
      <div className="flex gap-3">
        ...
        <div className="flex flex-col w-1/2">
          ...
          <div className="text-3xl font-bold text-black mt-0">5 Minutes</div>
        ...
        <div className="flex flex-col ml-auto self-end gap-1 mt-12">
          <button className="btn btn-blue">Attend Session</button>
          <button className="btn btn-neutral">Cancel Session</button>
        </div>
      </div>
    </div>
  );

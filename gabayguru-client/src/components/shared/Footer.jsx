...
const Footer = () => {
  return (
    <div className='max-w-screen bg-black'>
      <footer className="footer footer-center p-4 bg-black text-white max-w-[1400px] mx-auto my-0 py-10">
        <nav className="grid grid-flow-col gap-4">
          <a className="link link-hover"><Link to="/about">About</Link></a>
          <a className="link link-hover"><Link to="/">Browse Mentors</Link></a>
        ...
        <aside>
          <p>Copyright © 2024 - All right reserved by GabayGuru</p>
        </aside>
      </footer>
    </div>
  )
